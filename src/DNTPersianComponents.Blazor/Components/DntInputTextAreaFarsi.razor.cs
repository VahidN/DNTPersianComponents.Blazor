...
/// </summary>
public partial class DntInputTextAreaFarsi
{
    ...
    /// </summary>
    [Parameter]
    public string Direction { set; get; } = "rtl";

    /// <summary>
    ///     Should we convert English numbers to Persian numbers? Its default value is `true`.
    /// </summary>
    [Parameter]
    public bool ConvertEnglishNumbers { set; get; } = true;
    ...
    private string AutoComplete { set; get; } = "off";
