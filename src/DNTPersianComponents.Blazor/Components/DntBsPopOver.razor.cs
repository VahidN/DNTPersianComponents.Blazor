...
/// </summary>
public partial class DntBsPopOver
{
    ...
    /// </summary>
    [Parameter]
    public RenderFragment? PopOverBody { get; set; }
    ...
    /// </summary>
    [Parameter]
    public int ZIndex { set; get; } = 2021;

    /// <summary>
    ///     The header's label
    /// </summary>
    [Parameter]
    public string HeaderLabel { get; set; } = default!;

    /// <summary>
    ///     The close button's title. Its default value is `Close`.
    /// </summary>
    [Parameter]
    public string CloseTitle { get; set; } = "Close";
