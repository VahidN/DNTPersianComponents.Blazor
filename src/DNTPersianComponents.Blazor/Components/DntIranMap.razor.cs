...
namespace DNTPersianComponents.Blazor
{
    ...
    /// </summary>
    public partial class DntIranMap : ComponentBase
    {
        private string MapId { set; get; } = "iranMap" + Guid.NewGuid().ToString();

        private IranProvince? _selectedProvince;
        private IranProvince? _hoveredProvince;

        private IranProvinceValue<ScreenPosition> ClickedPostions { set; get; } = new();
        ...
        [Parameter] public IranProvinceValue<string> IranProvincesTitles { set; get; } = new();

        /// <summary>
		/// When you click at a province, a popover will be displayed.
        /// This property defined the body template of the opened popover.
        /// </summary>
        [Parameter] public RenderFragment<IranProvince>? IranProvincesBody { get; set; }
        ...
        /// Fires when a province is selected
        /// </summary>
        [Parameter] public EventCallback<IranProvince?> SelectedProvinceChanged { set; get; }
        ...
        /// Fires when a province is hovered over by mouse.
        /// </summary>
        [Parameter] public EventCallback<IranProvince?> HoveredProvinceChanged { set; get; }
        ...
        [SuppressMessage("Microsoft.Usage", "CA2227:Collection properties should be read only",
                        Justification = "It's a Blazor's [Parameter].")]
        [Parameter] public IranProvinceValue<string> IranProvincesStyles { set; get; } = new();
        ...
        [SuppressMessage("Microsoft.Usage", "CA2227:Collection properties should be read only",
                        Justification = "It's a Blazor's [Parameter].")]
        [Parameter] public IranProvinceValue<string> ProvinceNamesStyles { get; set; } = new();

        /// <summary>
        /// The stroke style of a province. Its default value is `black`.
        /// </summary>
        [Parameter] public string ProvinceStroke { set; get; } = "black";

        /// <summary>
        /// The stroke width of a province. Its default value is `2`.
        /// </summary>
        [Parameter] public int ProvinceStrokeWidth { set; get; } = 2;

        /// <summary>
        /// The fill color of a province. Its default value is `white`.
        /// </summary>
        [Parameter] public string ProvinceFill { set; get; } = "white";

        /// <summary>
        /// The style of `map-sea-names`.
        /// </summary>
        [Parameter] public string MapSeaNamesStyle { get; set; } = default!;

        /// <summary>
        /// The CSS class of `map-sea-names`.
        /// </summary>
        [Parameter] public string MapSeaNamesCss { get; set; } = default!;

        /// <summary>
        /// The CSS class of `main-svg`.
        /// </summary>
        [Parameter] public string MainSvgStyle { get; set; } = default!;

        /// <summary>
        /// Should we display the names of the provinces?
        /// Its default value is `true`.
        /// </summary>
        [Parameter] public bool ShowProvincesNames { get; set; } = true;
        ...
        private async Task ProvinceClickedAsync(IranProvince province, MouseEventArgs args)
        {
            if (IranProvincesTitles.Count > 0)
            {
                ...
                ClickedPostions[province] = position;
