...
namespace DNTPersianComponents.Blazor.ServerSample.Pages
{
    public partial class CustomPersianCalendar : ComponentBase
    {
        ...
        private async Task<IReadOnlyList<PersianDayEvents>> OnPerpareEventsAsync(EventDate eventDate)
        {
                    ...
                    new PersianDayEvents
                    {
                        ...
                        DayEvents = new List<DayEvent>
                        {
                            ...
                            new DayEvent
                            {
                                ...
                                Clicked = (day, @event) => Console.WriteLine($"{day.Year}/{day.Month}/{day.Day} @ {@event.StartTime} was clicked!")
                            }
                        }.AsReadOnly()
                    },
                    new PersianDayEvents
